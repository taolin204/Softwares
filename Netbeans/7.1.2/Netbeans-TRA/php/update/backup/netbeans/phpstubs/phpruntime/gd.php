 ...
 * @param resource $image
 * @param int $red <p>&gd.value.red;</p>
 * @param int $green <p>&gd.value.green;</p>
 * @param int $blue <p>&gd.value.blue;</p>
 ...
 * @param resource $dst_im <p>&gd.image.destination;</p>
 * @param resource $src_im <p>&gd.image.source;</p>
 * @param int $dst_x <p>
 ...
 * </p>
 * @param int $src_w <p>&gd.source.width;</p>
 * @param int $src_h <p>&gd.source.height;</p>
 * @return bool true on success or false on failure.
 */
 ...
 * to <b>imagecopy</b> for pallete images, while it
 ...
 * identically to <b>imagecopy</b> for pallete images, while
 ...
 * @param resource $dst_image <p>&gd.image.destination;</p>
 * @param resource $src_image <p>&gd.image.source;</p>
 * @param int $dst_x <p>
 * x-coordinate of destination point.
 * </p>
 * @param int $dst_y <p>
 ...
 * @param resource $image
 * @return bool true if the <i>image</i> is truecolor, false
 * otherwise.
 */
 ...
 * y-coordinate of source point.
 * </p>
 * @param int $width <p>&gd.source.width;</p>
 * @param int $height <p>&gd.source.height;</p>
 * @return resource &gd.return.identifier;
 */
 ...
 * @param resource $image
 * @param string $filename [optional] <p>&gd.image.path;</p>
 * <p>
 * null is invalid if the <i>quality</i> and
 ...
 * <i>quality</i> parameter, use null.
 * </p>
 * @param int $quality [optional] <p>
 ...
 * @param resource $image
 * @return int Return the width of the <i>image</i> or false on
 * errors.
 */
 ...
 * @param resource $image
 * @return int Return the height of the <i>image</i> or false on
 * errors.
 */
 ...
 * @param resource $image
 * @param float $size <p>&gd.font.size;</p>
 * @param float $angle <p>
 ...
 * A font resource, returned by <b>imagepsloadfont</b>.
 * </p>
 * @return bool true on success or false on failure.
 */
 ...
 * </p>
 * @param int $size <p>
 * <i>size</i> is expressed in pixels.
 * </p>
 ...
 * No pixels with the color <i>background</i> are
 ...
 * <i>tightness</i> allows you to control the amount
 ...
 * </tr>
 */
function imagepstext ($image, $text, $font_index, $size, $foreground, $background, $x, $y, $space = 0, $tightness = 0, $angle = 0.0, $antialias_steps = 4) {}
 ...
 * <b>IMG_FILTER_COLORIZE</b>: &gd.value.green;
 * @param int $arg3 [optional] <p>
 * <b>IMG_FILTER_COLORIZE</b>: &gd.value.blue;
