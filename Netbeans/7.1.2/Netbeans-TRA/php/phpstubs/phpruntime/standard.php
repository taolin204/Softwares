...
// Start of standard v.5.3.6-13ubuntu3.2
 ...
 * If the <i>cut</i> is set to true, the string is
 ...
 * <i>string</i> itself is valid for the character set, as
 ...
 * sequence within the given <i>charset</i> and the
 * <b>ENT_IGNORE</b> flag is not set, then
 * <b>htmlspecialchars</b> will return an empty string.
 */
function htmlspecialchars ($string, $flags = 'ENT_COMPAT | ENT_HTML401', $charset = null, $double_encode = true) {}
 ...
 * </p>
 * @param string $charset [optional] <p>
 * Like <b>htmlspecialchars</b>, it takes an optional
 * third argument <i>charset</i> which defines character
 ...
 */
function htmlentities ($string, $flags = 'ENT_COMPAT | ENT_HTML401', $charset = null, $double_encode = true) {}
 ...
 */
function html_entity_decode ($string, $quote_style = 'ENT_COMPAT', $charset = 'UTF-8') {}
 ...
 * There are two new constants (<b>HTML_ENTITIES</b>,
 * <b>HTML_SPECIALCHARS</b>) that allow you to specify the
 * table you want.
 * </p>
 * @param int $quote_style [optional] <p>
 * Like the <b>htmlspecialchars</b> and
 * <b>htmlentities</b> functions you can optionally specify
 * the <i>quote_style</i> you are working with.
 * See the description
 * of these modes in <b>htmlspecialchars</b>.
 * </p>
 * @param string $charset_hint [optional] <p>
 * Like <b>htmlentities</b>, it takes an optional
 * third argument <i>charset</i> which defines character
 * set used in conversion.
 * Presently, the ISO-8859-1 character set is used as the default.
 * </p>
 ...
 */
function get_html_translation_table ($table = 'HTML_SPECIALCHARS', $quote_style = 'ENT_COMPAT', $charset_hint = null) {}
 ...
 * If the optional <i>raw_output</i> is set to true,
 ...
 * @return string The loaded <i>php.ini</i> path, or false if one is not loaded.
 */
 ...
 * </p>
 * @param int $offset [optional] <p>
 * The optional <i>offset</i> parameter allows you
 * to specify which character in <i>haystack</i> to
 * start searching. The position returned is still relative to the
 * beginning of <i>haystack</i>.
 * </p>
 * @return int the position as an integer. If <i>needle</i> is
 * not found, <b>strpos</b> will return boolean
 * false.
 */
 ...
 * beginning of <i>haystack</i>.
 * </p>
 * @return int the position as an integer. If <i>needle</i> is not found,
 * <b>stripos</b> will return boolean false.
 */
 ...
 * <i>needle</i>. Also note that string positions start at 0,
 * and not 1.
 * </p>
 * <p>
 * If <i>needle</i> is not found, false is returned.
 */
 ...
 * If true, <b>strstr</b> returns
 * the part of the <i>haystack</i> before the first
 * occurrence of the <i>needle</i>.
 * </p>
 * @return string the portion of string, or false if <i>needle</i>
 * is not found.
 */
 ...
 * first occurrence of the <i>needle</i>.
 * </p>
 ...
 * </p>
 * <p>
 * false is returned if <i>split_length</i> is less than 1.
 ...
 * If <i>case_insensitivity</i> is true, comparison is
 * case insensitive.
 * </p>
 ...
 * Non-numeric <i>number</i> causes returning null and
 ...
 * <i>start</i> characters long, false will be returned.
 * </p>
 * <p>
 ...
 * If <i>locale</i> is null or the empty string
 ...
 * @return string the element as a string, or false if <i>item</i>
 * is not valid.
 */
 ...
 * or "udp" (in lowercase).
 * </p>
 * @return int the port number, or false if <i>service</i> or
 ...
 * feeding to <b>date</b>. Returns false on error.
 */
function getlastmod () {}
 ...
 * The value to check
 * </p>
 * @return bool true if <i>val</i> is a legal finite
 ...
 * <i>address</i>, or false if a syntactically invalid
 ...
 * </p>
 * @return int the IPv4 address or false if <i>ip_address</i>
 * is invalid.
 */
 ...
 * <i>varname</i>, or false if the environment
 ...
 * If used and set to true, <b>microtime</b> will return a
 ...
 * </p>
 * <p>
 * If <i>get_as_float</i> is set to true, then
 ...
 * If set to true, <b>uniqid</b> will add additional
 ...
 * <i>option</i>, or false if an error occurs.
 */
 ...
 * Using the <i>types</i> parameter, you can specify
 ...
 * </p>
 * <p>
 * Although the <i>prefix</i> parameter is optional, you
 * will get an <b>E_NOTICE</b> level
 ...
 * If used and set to true, <b>var_export</b> will return
 ...
 * highlighted code.
 * </p>
 * @return mixed If <i>return</i> is set to true, returns the highlighted
 ...
 * </p>
 * <p>
 * When <i>details</i> is true (default) the array will
 ...
 * </p>
 * <p>
 * When <i>details</i> is false the value will be the
 ...
 * </p>
 * @return bool <b>headers_sent</b> will return false if no HTTP headers
 ...
 * for <i>process_sections</i> is false
 * </p>
 ...
 * The host IP address.
 * </p>
 * @return string the host name or the unmodified <i>ip_address</i>
 * on failure.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is null, false
 * otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is a resource,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is a boolean,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is a float,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is an integer,
 * false otherwise.
 */
function is_int ($var) {}
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is a number or a numeric
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is of type string,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is an array,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is an object,
 * false otherwise.
 */
 ...
 * The variable being evaluated.
 * </p>
 * @return bool true if <i>var</i> is a scalar false
 * otherwise.
 */
 ...
 * the case.
 * </p>
 * @return bool true if <i>name</i> is callable, false
 * otherwise.
 */
 ...
 * to by <i>handle</i>. Returns false on EOF.
 */
 ...
 * <b>fopen</b> call will fail by returning false and
 ...
 * false. Otherwise, <b>fpassthru</b> returns
 ...
 * <i>pathname</i>. Defaults to false.
 * </p>
 * @param resource $context [optional] &note.context-support;
 * @return bool true on success or false on failure.
 */
 ...
 * <b>fopen</b>, for the new file or false on failure.
 */
function tmpfile () {}
 ...
 * </p>
 * <p>
 * If <i>tv_sec</i> is null <b>stream_select</b>
 ...
 * &note.line-endings;
 * <p>
 * <b>fgetcsv</b> returns null if an invalid
 * <i>handle</i> is supplied or false on other errors,
 ...
 * </p>
 * @param bool $use_include_path [optional] <p>
 * Setting <i>use_include_path</i> to true will result
 ...
 * </p>
 * <p>
 * <b>stream_wrapper_register</b> will return false if the
 ...
 * </p>
 * <p>
 * <b>realpath</b> returns false on failure, e.g. if
 ...
 * <b>fgets</b>, <b>fgetss</b>,
 * <b>fwrite</b>, <b>fclose</b>, and
 * <b>feof</b>). If the call fails, it will return false
 */
 ...
 * filesystem errors, <b>opendir</b> returns false and
 ...
 * expected by <b>chmod</b>, or false on failure.
 */
 ...
 * </p>
 * <p>
 * Returns false if an error occurs. <b>filetype</b> will also
 ...
 * <i>filename</i> exists; false otherwise.
 * </p>
 * <p>
 ...
 * The filename being checked.
 * </p>
 * @return bool true if the <i>filename</i> exists and is
 * writable.
 */
 ...
 * </p>
 * @return bool true if the file or directory specified by
 * <i>filename</i> exists and is readable, false otherwise.
 */
 ...
 * </p>
 * <p>
 * In case of error, <b>stat</b> returns false.
 */
 ...
 * <i>clear_realpath_cache</i> is true.
 * </p>
 * @return void
 */
 ...
 * </p>
 * <p>
 * If <i>output_callback</i> returns false original
 ...
 * If the optional parameter <i>erase</i> is set to false,
 ...
 * or with <i>full_status</i> = false a simple array
 ...
 * </p>
 * <p>
 * If called with <i>full_status</i> = true an array
 ...
 * parameters which will be filled by pairs of <i>array</i> keys.
 ...
 * 1 will be returned.
 * There is one exception, if <i>var</i> is null,
 * 0 will be returned.
 * </p>
 * <p>
 ...
 * empty, <b>current</b> returns false.
 */
 ...
 * </p>
 * @param bool $strict [optional] <p>
 * If the third parameter <i>strict</i> is set to true
 * then the <b>in_array</b> function will also check the
 * types of the
 * <i>needle</i> in the <i>haystack</i>.
 * </p>
 * @return bool true if <i>needle</i> is found in the array,
 * false otherwise.
 */
 ...
 * The input array.
 * </p>
 * @return mixed the shifted value, or null if <i>array</i> is
 ...
 * <p>
 * The comparison of arrays' data is performed by using an user-supplied
 * callback : <i>data_compare_func</i>. In this aspect
 ...
 * int<b>filter</b>
 * <b>resource<i>in</i></b>
 * <b>resource<i>out</i></b>
 * <b>int<i>consumed</i></b>
 * <b>bool<i>closing</i></b>
 * <p>
 * This method is called whenever data is read from or written to
 * the attached stream (such as with <b>fread</b> or <b>fwrite</b>).
 * <i>in</i> is a resource pointing to a bucket brigade
 * which contains one or more bucket objects containing data to be filtered.
 * <i>out</i> is a resource pointing to a second bucket brigade
 * into which your modified buckets should be placed.
 * <i>consumed</i>, which must always
 ...
 * <td>
 * The contents of the <i>params</i> parameter passed
 * to <b>stream_filter_append</b>
 * or <b>stream_filter_prepend</b>.
 * </td>
 * </tr>
 * <tr valign="top">
 ...
 * </p>
 * <p>
 * <b>stream_filter_register</b> will return false if the
...
// End of standard v.5.3.6-13ubuntu3.2
?>
