 ...
 * @param resource $statement A valid OCI8 statement identifier created by <b>oci_parse</b> and executed by <b>oci_execute</b>, or a REF CURSOR statement identifier.
 ...
 * </p>
 * @return bool true if <i>field</i> is null, false otherwise.
 */
 ...
 * Can be the field's index (1-based) or name.
 * </p>
 * @return int the size of a <i>field</i> in bytes, or false on
 * errors.
 */
 ...
 * the <i>statement</i> then false is returned.
 * </p>
 * <p>
 ...
 * </p>
 * @param string $connection_string [optional] <p>Contains the Oracle instance to connect to. It can be an Easy Connect string, or a Connect Name from the tnsnames.ora file, or the name of a local Oracle instance.</p><p>If not specified, PHP uses environment variables such as <b>TWO_TASK</b> (on Linux) or <b>LOCAL</b> (on Windows) and <b>ORACLE_SID</b> to determine the Oracle instance to connect to. </p><p>To use the Easy Connect naming method, PHP must be linked with Oracle 10g or greater Client libraries. The Easy Connect string for Oracle 10g is of the form: [//]host_name[:port][/service_name]. With Oracle 11g, the syntax is: [//]host_name[:port][/service_name][:server_type][/instance_name]. Service names can be found by running the Oracle utility lsnrctl status on the database server machine.</p><p>The tnsnames.ora file can be in the Oracle Net search path, which includes $ORACLE_HOME/network/admin and /etc. Alternatively set TNS_ADMIN so that $TNS_ADMIN/tnsnames.ora is read. Make sure the web daemon has read access to the file.</p>
 ...
 * false. Otherwise, <b>oci_error</b> returns the
 ...
 * @param resource $connection An Oracle connection identifier, returned by <b>oci_connect</b>, <b>oci_pconnect</b>, or <b>oci_new_connect</b>.
 ...
 * </p>
 * @return OCI_Collection a new <b>OCICollection</b> object or false on
 * error.
 */
